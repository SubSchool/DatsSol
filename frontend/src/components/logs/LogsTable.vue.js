...
}
{
    ...
    const __VLS_10 = __VLS_asFunctionalComponent(__VLS_9, new __VLS_9({
        modelValue: (__VLS_ctx.localFilters.category),
    ...
    const __VLS_36 = {
        onClick: (...[$event]) => {
            __VLS_ctx.emit('refresh', __VLS_ctx.localFilters);
        }
    };
    var __VLS_32;
    ...
    {
        const { body: __VLS_thisSlot } = __VLS_80.slots;
        const [{ data }] = __VLS_getSlotParams(__VLS_thisSlot);
